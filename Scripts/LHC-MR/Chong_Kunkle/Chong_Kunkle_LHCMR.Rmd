...
## Merging Chong and Kunkle datasets (X and Y) 
...
saveRDS(SP_list, "/wynton/group/andrews/users/achatterjee/mtdnacn/Brian-Estimating-Causality-mtDNAcn-on-Alzheimer/data/LHC-MR/Chong_Kunkle_SP_list.rds")
```
