...
## Merging Longchamps and Kunkle datasets (X and Y) 
```{r}
## Step 1
trait.names=c("mtDNAcn_Apoe_removed","Kunkle_AD")
input.files = list(longchamps_apoe, kunkle_apoe)
...
saveRDS(SP_list, "/wynton/group/andrews/users/achatterjee/mtdnacn/Brian-Estimating-Causality-mtDNAcn-on-Alzheimer/data/LHC-MR/Aadrita's_LHC-MR_analyses/LHC_MR_Longchamps_Kunkle_apoe_removed/Longchamps_Kunkle_SP_list.rds")
```
